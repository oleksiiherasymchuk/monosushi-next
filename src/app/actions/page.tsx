...
export default function Discounts() {
  return (
        ...
        return (
          ...
          <div className={styles.actionsDiscountsDiscount} key={discount.id}>
            <div className={styles.actionsDiscountsDiscountImg}>
              ...
              {/* <Link href="/actions/[id]" as={`/actions/${discount.id}`}> */}
    ...
    <div className={styles.actionsText}>
      ...
      <p>Мрієте смакувати суші, не переплачуючи? З Monosushi це можливо! Ми зібрали найвигідніші акційні суші у Львові у цьому розділі сайту. Ви можете легко ознайомитися з усіма спеціальними пропозиціями та замовити роли за привабливою ціною. А ще — отримати рол або цілий сет у подарунок!</p>
      </div>
 
      <div className={styles.actionsTextItem}>
      <h2>Акційні суші, які вам точно сподобаються</h2>
      <p>Ми пропонуємо смачні та вигідні акції, які допоможуть смакувати ролами вигідно:</p>
      <ul>
        ...
        <li>Фотомарафон — розіграш ролів за контент зі згадкою Monosushi в соціальних мережах.</li>
      </ul>
      </div>

      <div className={styles.actionsTextItem}>
        <h2>Доставка суші по акції у Львові: правила від Monosushi</h2>
        <p>Більшість наших акцій не сумуються між собою, а також доступні при замовленні суші на певну суму. Ознайомитися з правилами та умовами кожної акції можна, натиснувши “Дізнатися більше”. Також наші менеджери із задоволенням проконсультують вас акцій на суші у Львові.</p>
        <p>Швидка доставка акційних суші, неповторний смак, аромат та гарна подача гарантовані. Адже ми — справжні перфекціоністи, які дуже уважні до дрібниць. Готуємо роли з добірних продуктів, стежимо за дотриманням усіх тонкощів кулінарного процесу. На нашій кухні стерильно, а наші рецепти — досконалі.</p>
        <p>Скоріш оформляйте замовлення та смакуйте улюблені роли вигідно з Monosushi!</p>
      </div>
    </div>
    </div>
  );
